<template lang="html">
  <section class="card vertical-pull-lg">
    <div class="card-block card-block--top" data-theme="light-20">
      ...
      <sheet-stats :stats="data.stats" :totals="data.uniques.data" :uniques="data.trueUniques"></sheet-stats>
    ...
    <div class="card-block" v-if="!collapsed">
      <div class="row row-flex">
        ...
        <detail-colors v-for="color in data.trueUniques.color" :color="color.value" :uses="color.count"></detail-colors>
        ...
        <detail-bg-colors v-for="color in data.trueUniques.backgroundColor" :color="color.value" :uses="color.count"></detail-bg-colors>
        ...
        <detail-text v-for="text in data.trueUniques.fontSize" :value="text.value" :uses="text.count"></detail-text>
        ...
        <detail-text v-for="text in data.trueUniques.fontFamily" :value="text.value" :uses="text.count"></detail-text>
        ...
        <detail-text v-for="text in data.trueUniques.mediaQueries" :value="text.value" :uses="text.count"></detail-text>
